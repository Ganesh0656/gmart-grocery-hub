-- Insert sample categories with images (using INSERT ... WHERE NOT EXISTS pattern)
INSERT INTO public.categories (name, description, image_url) 
SELECT 'Fresh Produce', 'Fresh fruits and vegetables', '/src/assets/category-fresh-produce.jpg'
WHERE NOT EXISTS (SELECT 1 FROM public.categories WHERE name = 'Fresh Produce');

INSERT INTO public.categories (name, description, image_url) 
SELECT 'Dairy Products', 'Milk, cheese, yogurt and more', '/src/assets/category-dairy.jpg'
WHERE NOT EXISTS (SELECT 1 FROM public.categories WHERE name = 'Dairy Products');

INSERT INTO public.categories (name, description, image_url) 
SELECT 'Meat & Poultry', 'Fresh meat and poultry', '/src/assets/category-meat.jpg'
WHERE NOT EXISTS (SELECT 1 FROM public.categories WHERE name = 'Meat & Poultry');

INSERT INTO public.categories (name, description, image_url) 
SELECT 'Bakery', 'Fresh bread and baked goods', '/src/assets/category-bakery.jpg'
WHERE NOT EXISTS (SELECT 1 FROM public.categories WHERE name = 'Bakery');

INSERT INTO public.categories (name, description, image_url) 
SELECT 'Beverages', 'Drinks, juices, and beverages', '/src/assets/category-beverages.jpg'
WHERE NOT EXISTS (SELECT 1 FROM public.categories WHERE name = 'Beverages');

INSERT INTO public.categories (name, description, image_url) 
SELECT 'Frozen Foods', 'Frozen meals and ice cream', '/src/assets/category-frozen.jpg'
WHERE NOT EXISTS (SELECT 1 FROM public.categories WHERE name = 'Frozen Foods');
